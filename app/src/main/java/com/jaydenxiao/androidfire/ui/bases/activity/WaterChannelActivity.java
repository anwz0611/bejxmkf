package com.jaydenxiao.androidfire.ui.bases.activity;
...
import com.jaydenxiao.androidfire.ui.bases.model.AssociationInfoModel;
import com.jaydenxiao.androidfire.ui.bases.model.WaterChannelModel;
import com.jaydenxiao.androidfire.ui.bases.presenter.AssociationInfoPresenter;
import com.jaydenxiao.androidfire.ui.bases.presenter.WaterChannelPresenter;
        ...
        WSListAdapter = new CommonRecycleViewAdapter<waterChannelBeans>(mContext, R.layout.waterchannel_list_item) {
            ...
            public void convert(ViewHolderHelper helper, waterChannelBeans waterChannelBeans) {
                ...
                if (waterChannelBeans.getType().equals("") || !waterChannelBeans.getType().equals("0")) {
                    helper.setText(R.id.textView6, "渠道类型：" + waterChannelBeans.getType());
                } else
